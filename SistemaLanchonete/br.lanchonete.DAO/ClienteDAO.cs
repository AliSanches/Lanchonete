...
namespace SistemaLanchonete
{
    public class ClienteDAO
    {
        ...
        public bool CamposValidos(Cliente obj)
        {
            ...
            if (CampoVazio(obj.nomeCompleto) || CampoVazio(obj.cpf) || CampoVazio(obj.celular) || CampoVazio(obj.estado) || CampoVazio(obj.cidade) || CampoVazio(obj.bairro) || CampoVazio(obj.rua) || CampoVazio(obj.numero.ToString()) || CampoVazio(obj.codigo.ToString()))
            {
            ...
            if (!ApenasNumeros(obj.numero.ToString()) || !ApenasNumeros(obj.codigo.ToString()))
            {
        ...
        public void ExcluirCliente(Cliente obj)
        {
            ...
            {
                MessageBox.Show("NEGADO", "NEGADO", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        public Cliente BuscarPorCPF(string cpf)
        {
            try
            {
                ...
                cmd.CommandText = "SELECT id_cliente, nome FROM cliente WHERE cpf = @cpf";
